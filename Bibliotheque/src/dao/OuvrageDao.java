...
public class OuvrageDao {    
    ...
    public List<Ouvrage> findOuvrageByAuteur(Auteur a){
        EntityManager em = JpaUtil.getEntityManager();
        Query query = em.createQuery("select o from Ouvrage as o where o.auteur=:auteur")
                .setParameter("auteur", a);
        List<Ouvrage> liste = query.getResultList();
        return liste;
    }
    ...
    public List<Ouvrage> findOuvrageByAuteur(String na){
        EntityManager em=JpaUtil.getEntityManager();
        Query query = em.createQuery("select o from Ouvrage as o where o.auteur.nom=:nomAuteur")
                .setParameter("nomAuteur",na);
        List<Ouvrage> liste = query.getResultList();
        return liste;
    }
}
